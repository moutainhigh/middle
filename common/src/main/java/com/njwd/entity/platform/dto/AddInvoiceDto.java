...
public class AddInvoiceDto implements Serializable {
    ...
    @ApiModelProperty(value = "状态：0开票中1已开票（前端不传）")
    ...
    @ApiModelProperty(value = "客户名称，前端不传")
    ...
    @ApiModelProperty(value = "开票时间，新增不传")
    private String invoice_time;//开票时间

    @ApiModelProperty(value = "发票编码，新增不传")
    ...
    @ApiModelProperty(value = "开票申请ID,新增不传")
    ...
    @ApiModelProperty(value = "申请时间，新增不传")
    ...
    @ApiModelProperty(value = "客户ID，前端不传")
    private String customer_id;//客户ID

    @ApiModelProperty(value = "开票对应的账单id(逗号隔开的字符串)")
    private String bill_id;//客户ID
}
