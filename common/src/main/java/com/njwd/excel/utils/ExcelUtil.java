package com.njwd.excel.utils;

import com.alibaba.excel.EasyExcelFactory;
import com.alibaba.excel.ExcelReader;
import com.alibaba.excel.ExcelWriter;
import com.alibaba.excel.handler.AfterWriteHandlerImpl;
...
public class ExcelUtil {
	 ...
	 * @param fileName      文件名
	 * @param sheetName     表名称
	 * @param excelTypeEnum EXCEL格式(枚举)
	 * @author 郑勇浩
	 */
	public static void writeSampleExcel(List<String> head, List<List<String>> data, String fileName, String sheetName, ExcelTypeEnum excelTypeEnum) throws IOException {
		if (StringUtils.isEmpty(fileName)) {
			fileName = System.currentTimeMillis() + "." + excelTypeEnum;
		}
		if (StringUtils.isEmpty(sheetName)) {
			sheetName = "sheet1";
		}
		OutputStream out = new FileOutputStream(fileName);
		ExcelWriter writer = EasyExcelFactory.getWriterWithTempAndHandler(null, out, excelTypeEnum, true, new AfterWriteHandlerImpl());
