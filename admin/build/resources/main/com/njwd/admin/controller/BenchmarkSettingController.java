...
public class BenchmarkSettingController extends BaseController {
    ...
    public Result toGetAllBenchmark(@RequestBody BenchmarkDto benchmarkDto){
        ...
        List<BenchmarkVo> benchmarkVoList = benchmarkSettingService.getAllBenchmark(benchmarkDto.getEnterpriseId());
    ...
    public Result toGetBenchmarkConfigList(@RequestBody BenchmarkDto benchmarkDto){
        // 判断参数为空
        if (benchmarkDto == null) {
        ...
        List<BenchmarkConfigVo> benchmarkVoList = benchmarkSettingService.getBenchmarkConfigList(benchmarkDto.getBenchmarkCode());
        return ok(benchmarkVoList);
    }
