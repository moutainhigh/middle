...
public interface MasterDataUnifiedMapper extends BaseMapper {
     ...
     * @return
     */
    String selectDisplayColumn(MasterDataUnifiedDto masterDataUnifiedDto);
     ...
     * 自定义查询分页数量
     * @author XiaFq
     * @date 2020/4/15 1:02 下午
     * @param masterDataUnifiedDto
     * @return
     */
    Long getMasterDataListCount(@Param("masterDataUnifiedDto") MasterDataUnifiedDto masterDataUnifiedDto);
     ...
     * 获取字段描述
     * @author XiaFq
     * @date 2020/1/2 2:20 下午
     * @param masterDataUnifiedDto
     * @return List<Map>
     */
    List<Map<String, String>> getColumnDisplayDescList(MasterDataUnifiedDto masterDataUnifiedDto);
}
