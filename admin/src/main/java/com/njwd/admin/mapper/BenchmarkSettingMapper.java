...
public interface BenchmarkSettingMapper extends BaseMapper {
     ...
     * @return
     */
    List<BenchmarkVo> getAllBenchmark(@Param("benchmarkDto") BenchmarkDto enterpriseId);
     ...
     */
    Page<BenchmarkConfigVo> getBenchmarkConfigList(Page<BenchmarkDto> page, @Param("benchmarkDto") BenchmarkDto benchmarkCode);
