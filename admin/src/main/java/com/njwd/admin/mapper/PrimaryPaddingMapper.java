...
public interface PrimaryPaddingMapper{
     ...
     * @return
     */
    List<TableAttributeVo> getTableAllAttributeVo(List<TableObj> tableName);
    ...
    List<PrimaryPaddingVo> getPrimayPaddingRuleByApp(EnterpriseAppDataTypeDto enterpriseAppDataTypeDto);
}
