...
public interface EnterpriseAppService {
    ...
    */
     ...
     */
    EnterpriseAppOperationVo toAddEnterpriseApp(EnterpriseInstallAppDto enterpriseInstallAppDto);
     ...
     * @return int -1 更新失败 0 更新成功
     */
    int updateEnterpriseAppConfig(EnterpriseAppInfoDto enterpriseAppInfoDto);
